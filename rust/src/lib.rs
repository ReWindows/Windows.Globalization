//! Windissect-generated Rust FFI bindings for Windows.Globalization.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "89FB479B9759B9447A8C5EB7A4ADDA4D";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 798844927;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 26] = [87, 105, 110, 100, 111, 119, 115, 46, 71, 108, 111, 98, 97, 108, 105, 122, 97, 116, 105, 111, 110, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 798844927 { return 0; }
