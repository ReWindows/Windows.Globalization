// Flat C exports observed in Windows.Globalization.dll. Unknown ABIs are intentionally not declared.
// Validated dialects: ISO C17/C23/C26 draft and Windissect C20 (C ABI under C++20).
#pragma once
#ifndef WINDOWS_GLOBALIZATION_C_H
#define WINDOWS_GLOBALIZATION_C_H
...
#endif
#endif // WINDOWS_GLOBALIZATION_C_H
